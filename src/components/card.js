...
function card(props){
    return(    
        <Card className={props.className} style={{width: "48%", height: "750px", padding: "30px", margin: "15px", float: "left", backgroundColor : "#262626"}}>
            <h2 classname="projectTitle" style={{fontSize : "50px", fontWeight: "bold", color : "#ffffff"}}>{props.title}</h2>
            <img className="websiteImage"  src={props.image} style={{width: "100%", height: "500px"}} alt="project example"/>
